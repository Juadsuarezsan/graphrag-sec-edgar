# Architecture — GraphRAG over SEC EDGAR

## Summary

Neo4j-compatible in-memory knowledge graph over the S&P 500. Query classifier routes lookup / multi-hop / aggregation; engine traverses + synthesizes with citations.
